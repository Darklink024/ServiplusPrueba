...
namespace net.paxialabs.mabe.serviplus.entities.Entity.SAP
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("ORDENES", Namespace = "", IsNullable = false)]
    public class RootODS
    {
        [System.Xml.Serialization.XmlElementAttribute("ODS")]
        public SAPODS[] ODS { get; set; }
    }
