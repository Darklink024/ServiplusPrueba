...
namespace net.paxialabs.mabe.serviplus.entities.Entity.SAP
{
    ...
    [System.Xml.Serialization.XmlRootAttribute("CLIENTES", Namespace = "", IsNullable = false)]
    public class RootCliente
    {
        [System.Xml.Serialization.XmlElementAttribute("ODSCLIENTE")]
        public ODSCLIENTE[] CLIENTES { get; set; }
    }
